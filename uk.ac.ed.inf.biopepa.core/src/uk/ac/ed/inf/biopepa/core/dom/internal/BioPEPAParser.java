 ...
 * 
 * @version Thu Jan 28 11:47:39 GMT 2010
 */
public class BioPEPAParser extends java_cup.runtime.lr_parser {

	/** Default constructor. */
	public BioPEPAParser() {
		super();
	}

	/** Constructor which sets the default scanner. */
	public BioPEPAParser(java_cup.runtime.Scanner s) {
		super(s);
	}

	/** Constructor which sets the default scanner. */
	public BioPEPAParser(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
		super(s, sf);
	}

	/** Production table. */
	protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\122\000\002\002\004\000\002\002\004\000\002\003"
			...
			+ "\034\005\000\002\041\004\000\002\041\002\000\002\042" + "\004\000\002\042\002" });
	...
	/** Parse-action table. */
	protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\237\000\014\010\ufffe\041\ufffe\047\ufffe\050\ufffe\051"
	...
	protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\237\000\006\002\004\003\003\001\001\000\026\004"
			...
			+ "\001\001\000\002\001\001\000\002\001\001\000\002\001" + "\001\000\002\001\001" });
	...
	/*
	 * Prepares the list of expected input tokens. It doesn't try any recover
	 * action. Hence, unrecovered_syntax_error is likely to be thrown
	 */
	...
	/**
	 * Fetches column and line number from the lexer, and then throws an
	 * exception containing the error message to signal that parsing has been
	 * unsuccessful. If the symbol contains a value, this is also reported.
	 */
	public void unrecovered_syntax_error(java_cup.runtime.Symbol Current) throws ParserException {
		...
		throw new ParserException(pl.getCurrentChar(), (pl.getCurrentLineNumber() + 1), pl.getCurrentColumn(), pl
				.yylength(), "Syntax Error. Current symbol: '"
				+ (Current.value == null ? gettokenstr(Current.sym) : Current.value) + "'. Expected : "
				+ m_sExpected.toString());
	}
...
class CUP$BioPEPAParser$actions {
	...
	private void clearProperties() {
		properties = new LinkedList<Expression>();
	}
	...
	Expression createInfixExpression(Expression lhs, Expression rhs, InfixExpression.Operator op) {
	...
	public final java_cup.runtime.Symbol CUP$BioPEPAParser$do_action(int CUP$BioPEPAParser$act_num,
			java_cup.runtime.lr_parser CUP$BioPEPAParser$parser, java.util.Stack CUP$BioPEPAParser$stack,
			int CUP$BioPEPAParser$top) throws java.lang.Exception {
		...
		case 81: // action_sep ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("action_sep", 32,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
		...
		case 80: // action_sep ::= COMMA action_list
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("action_sep", 32,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 1)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 79: // action_list ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("action_list", 31,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 78: // action_list ::= NAME action_sep
		{
			...
			String name = (String) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			addName(name);
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("action_list", 31,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 1)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		...
		case 77: // action_set ::= LCOOP action_list RCOOP
		{
			NameSet RESULT = null;
			RESULT = doneNameList();
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("action_set", 26,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 2)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 75: // transport_operator ::= BMOVE
		{
			Integer RESULT = null;
			RESULT = BMOVE;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("transport_operator", 21,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 73: // operator ::= PRODUCT
		{
			Integer RESULT = null;
			RESULT = PRODUCT;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("operator", 20,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 68: // system_equation ::= LPAREN system_equation RPAREN
		{
			...
			Expression expr = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			RESULT = expr;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("system_equation", 30,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 2)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 67: // system_equation ::= system_equation action_set
					// system_equation
		{
			Expression RESULT = null;
			...
			Expression lhs = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 2)).value;
			...
			NameSet set = (NameSet) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
		...
		case 65: // system_equation ::= component_name LSQUARE expr RSQUARE
		{
			...
			Expression _expr = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;

			RESULT = createComponent(name, _expr);

			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("system_equation", 30,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 64: // cooperation ::= LPAREN cooperation RPAREN
		{
			...
			Expression coop = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			RESULT = coop;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("cooperation", 19,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 2)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 62: // cooperation ::= component_name LSQUARE expr RSQUARE
		{
			...
			Expression level = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 61: // pepa_action ::= variable_name LSQUARE variable_name
					// transport_operator variable_name RSQUARE
		{
			Expression RESULT = null;
			...
			Integer o = (Integer) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 2)).value;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("pepa_action", 25,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 5)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 59: // complete_activity ::= LPAREN pepa_action COMMA expr RPAREN
		{
			...
			int nameleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)).left;
			int nameright = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)).right;
			Expression name = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 3)).value;
			int stoichometryleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).left;
			int stoichometryright = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).right;
			Expression stoichometry = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("complete_activity", 24,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 4)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 58: // activity ::= pepa_action
		{
			...
			RESULT = name;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("activity", 23,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 56: // prefix_name ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("prefix_name", 17,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 54: // prefix ::= activity operator prefix_name
		{
			...
			int _activityright = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 2)).right;
			Expression _activity = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 2)).value;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("prefix", 22,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 2)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 53: // sequential_component ::= sequential_component PLUS
					// sequential_component
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("sequential_component", 18,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 2)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 51: // expr ::= NAME LPAREN function_parameter RPAREN
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("expr", 27,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 40: // type ::= MEMBRANE
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("type", 29,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 38: // key ::= MIN_CONC
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("key", 28,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 34: // property_sep ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("property_sep", 12,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 32: // property ::= TYPE EQUALS type property_sep
		{
			...
			PropertyLiteral _type = (PropertyLiteral) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("property", 33,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 31: // property ::= key EQUALS expr property_sep
		{
			...
			PropertyLiteral keyExpr = (PropertyLiteral) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 3)).value;
			int _exprleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 1)).left;
			int _exprright = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 1)).right;
			Expression _expr = (Expression) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
		...
		case 30: // optional_properties ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("optional_properties", 11,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 28: // parameter_sep ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("parameter_sep", 10,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 26: // function_parameter ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("function_parameter", 9,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 24: // variable_name ::= NAME
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("variable_name", 15,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 23: // other_locations ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("other_locations", 13,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 22: // other_locations ::= COMMA NAME other_locations
		{
			...
			String location = (String) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
		...
		case 21: // ml_component_name ::= NAME
		{
			...
			String name = (String) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()).value;
			RESULT = createName(name);
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("ml_component_name", 16,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 19: // component_name ::= NAME
		{
			...
			String name = (String) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()).value;
			RESULT = createName(name);
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("component_name", 14,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 18: // component_name ::= NAME AT NAME
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 17: // compositional_declaration ::= variable_name COLON COLON
					// EQUALS cooperation SEMI
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("compositional_declaration", 8,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 5)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 16: // behaviour_declaration ::= variable_name EQUALS
					// sequential_component SEMI
		{
			Statement RESULT = null;
			int nameleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)).left;
			int nameright = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)).right;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("behaviour_declaration", 5,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 15: // function_declaration ::= variable_name EQUALS LSQUARE expr
					// RSQUARE SEMI
		{
			Statement RESULT = null;
			int nameleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 5)).left;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("function_declaration", 4,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 5)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 14: // function_declaration ::= FUNCTION variable_name COLON expr
					// SEMI
		{
			Statement RESULT = null;
			int nameleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)).left;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 13: // species_declaration ::= SPECIES ml_component_name COLON
					// property SEMI
		{
			Statement RESULT = null;
			int nameleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)).left;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("species_declaration", 6,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 4)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 12: // location_declaration ::= LOCATION_DEF NAME IN NAME
					// optional_properties SEMI
		{
			Statement RESULT = null;
			...
			String location = (String) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 4)).value;
			...
			String parent = (String) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 2)).value;
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("location_declaration", 7,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 5)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 11: // location_declaration ::= LOCATION_DEF variable_name
					// optional_properties SEMI
		{
			Statement RESULT = null;
			int nameleft = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 2)).left;
		...
		case 10: // variable_declaration ::= variable_name EQUALS expr SEMI
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("variable_declaration", 3,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 3)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 9: // statement ::= compositional_declaration
		{
			...
			RESULT = s;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("statement", 2,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 3: // statements ::=
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("statements", 1,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 1: // biopepa_model ::= statements system_equation
		{
			...
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("biopepa_model", 0,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 1)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			return CUP$BioPEPAParser$result;
		...
		case 0: // $START ::= biopepa_model EOF
		{
			...
			int start_valright = ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).right;
			Model start_val = (Model) ((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack
					.elementAt(CUP$BioPEPAParser$top - 1)).value;
			RESULT = start_val;
			CUP$BioPEPAParser$result = parser.getSymbolFactory().newSymbol("$START", 0,
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.elementAt(CUP$BioPEPAParser$top - 1)),
					((java_cup.runtime.Symbol) CUP$BioPEPAParser$stack.peek()), RESULT);
		}
			/* ACCEPT */
