 ...
 * <code>
 * IChart chart = ... <br>
 * paintCanvas = new Canvas( composite, SWT.BORDER ); <br>
 * paintCanvas.setLayoutData( new GridData( GridData.FILL_BOTH ) ); <br>
 * paintCanvas.setBackground( Display.getDefault().getSystemColor( SWT.COLOR_WHITE ) ); <br>
 * preview = new ChartPreview( chart ); <br>
 * paintCanvas.addPaintListener( preview ); <br>
 * paintCanvas.addControlListener( preview );<br>
 * preview.setPreview( paintCanvas );<br>
 * preview.renderModel();<br> 
 * </code>
 */
